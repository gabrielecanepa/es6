...
// Inside an HTTP request there is a GET method (what is being typed), in a GET there in an URL

// HTTP Headers
// Usually an HTTP request is done with a GET method, containing an URL and an header. AN header example:
...
// Cache-Control:max-age=0 // -> checks if the browser is capable of caching content
